...
- 中学校段階の漢字1,110字と、ワカルート推奨の学年別学習順
- 小学校復習650語＋中学校推奨1,800語の英単語一覧と検索
- 数学・理科・社会を、公式・図・実験・地図・時系列・資料読解で学ぶカード
- 文部科学省の学校コードを基にした全国高校検索
- モバイルアプリからも利用できる学校・漢字・英単語JSON API
...
- [中学校漢字データ](Data/Kanji/README.md)：KANJIDIC2由来部分をCC BY-SA 4.0で提供します。
- [英単語データ](Data/EnglishVocabulary/README.md)：NGSL 1.2由来の語彙リストをCC BY-SA 4.0、EJDict-hand由来の日本語語義をCC0で利用しています。
- [数学・理科・社会の学習カード](Data/StudyCards/README.md)：学習指導要領の範囲を参照して独自作成し、Apache License 2.0で提供します。

どちらの中1・中2・中3への割り振りも、国や教科書の公式配当ではなく、ワカルートが作成した学習順です。再利用する場合は、各ディレクトリの`NOTICE.md`とデータ内のライセンス情報を保持してください。
